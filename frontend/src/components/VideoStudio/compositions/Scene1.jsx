...
export function Scene1({ scene1Headline: headline, heroSrc, brandName, bgColor, accent }) {
  ...
  const imgSrc = heroSrc?.startsWith('http') ? heroSrc : null
  ...
  return (
    <AbsoluteFill style={{ background: bgColor, opacity: sceneOp, overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        fontFamily: '"Anek Malayalam", "Noto Sans Malayalam", system-ui, sans-serif',
